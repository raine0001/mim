...
SIGNATURE_FILES = [
    ...
    "core/web_automation_service.py",
    ...
    "docs/objective-85-operator-governed-resolution-commitments.md",
    "docs/objective-85-promotion-readiness-report.md",
    "docs/objective-86-commitment-enforcement-drift-monitoring-loop.md",
    "docs/objective-87-commitment-outcome-learning-loop.md",
...
CAPABILITIES = [
    ...
    "operator_preference_policy_convergence",
    ...
    "web_page_summarization",
    "carrier_web_automation",
    "carrier_auth_pause_resume",
    "carrier_navigation_engine",
    "carrier_file_acquisition",
    "carrier_playbook_management",
    "carrier_failure_recovery",
    "carrier_email_ingestion_mfa",
    "carrier_reconciliation",
    "carrier_execution_status_dashboard",
...
RECENT_CHANGES = [
    ...
    "Added Objective 90 readiness-gated execution integration with trace, policy, and state-bus propagation",
    ...
    "Completed Objective 85 operator-governed resolution commitments with shared commitment propagation into inquiry, autonomy, strategy, stewardship, maintenance, and operator-visible reasoning",
    "Completed Objective 86 commitment enforcement and drift monitoring with inspectable health scoring, governance feedback, and inquiry-triggered commitment recalibration",
    ...
    "Added guarded web page summarization endpoint with external-memory persistence",
    ...
    "Added carrier automation APIs for web control, auth challenge pause/resume, navigation steps, file acquisition, playbooks, recovery, email MFA extraction, reconciliation, and run-status monitoring",
]
...
def build_manifest() -> dict:
    return {
        ...
        "endpoints": [
            ...
            "/automation/web/sessions/{session_id}/navigate",
            "/automation/web/sessions/{session_id}/actions",
            "/automation/web/sessions/{session_id}/state",
            "/automation/web/sessions/{session_id}",
            "/automation/auth/resolve",
            "/automation/auth/challenges/{challenge_key}",
            "/automation/auth/challenges/{challenge_key}/pause",
            "/automation/auth/challenges/{challenge_key}/resume",
            "/automation/navigation/execute",
            "/automation/files/detect",
            "/automation/files/download",
            "/automation/files/{artifact_id}",
            "/automation/playbooks",
            "/automation/playbooks/{carrier_id}",
            "/automation/playbooks/{carrier_id}/refine",
            "/automation/recovery/evaluate",
            "/automation/recovery/retry",
            "/automation/email/poll",
            "/automation/email/messages",
            "/automation/email/extract-mfa",
            "/automation/reconciliation/evaluate",
            "/automation/runs",
            "/automation/runs/{run_id}",
            "/automation/runs/{run_id}/carriers",
            ...
            "/operator/resolution-commitments/{commitment_id}",
            "/operator/resolution-commitments/{commitment_id}/revoke",
            "/operator/resolution-commitments/{commitment_id}/expire",
