...
\restrict 0AmpcI2dkAEYP2zaav7TaFqOW5OGUtXPXRO3SUiFSl0mlbeofpn3KnxaUsMd6gb
...
COPY public.actions (id, goal_id, engine, action_type, input_ref, expected_state_delta, validation_method, started_at, completed_at, status) FROM stdin;
1	2	local	prod-probe	prod://objective18	{"counter": 1}	expected_delta_compare	2026-03-10 05:09:36.228338+00	2026-03-10 05:09:36.22834+00	completed
2	4	local	prod-custody-probe	prod://o181	{"counter": 1}	expected_delta_compare	2026-03-10 05:27:02.251289+00	2026-03-10 05:27:02.251292+00	completed
\.
...
SELECT pg_catalog.setval('public.execution_journal_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.state_snapshots_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.validation_results_id_seq', 2, true);
...
\unrestrict 0AmpcI2dkAEYP2zaav7TaFqOW5OGUtXPXRO3SUiFSl0mlbeofpn3KnxaUsMd6gb
