...
\restrict 2BYNKg2DCp0dohkhbCqVqctHi5d5yOKqKpWScp6514SaaFHN3UpWuclKxcDnmut
...
SELECT pg_catalog.setval('public.execution_journal_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.goal_plans_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.state_snapshots_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.validation_results_id_seq', 12, true);
...
\unrestrict 2BYNKg2DCp0dohkhbCqVqctHi5d5yOKqKpWScp6514SaaFHN3UpWuclKxcDnmut
